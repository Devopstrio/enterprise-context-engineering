...
from context_engineering.retrieval.retrieval_integrator import RetrievalDocument, RetrievalIntegrator
...
class ContextAssembler:
    ...
    def assemble(self, request: ContextAssemblyRequest) -> AssembledContext:
        ...
        final_context: list[dict[str, str]] = [{"role": "system", "content": sys_prompt}]
        ...
        total_tokens = (
            self.budget_optimizer.estimate_tokens(sys_prompt)
